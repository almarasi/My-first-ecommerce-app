        ...
        <div className="bg-white/80 backdrop-blur-sm rounded-2xl shadow-xl border border-white/20 p-8 animate-fadeInUp">
          ...
          <Form {...form}>
            <form onSubmit={form.handleSubmit(HandleRegister)} className="space-y-5">
              ...
              <Button 
                type="submit" 
                className="cursor-pointer w-full h-12 text-base font-semibold bg-gradient-to-r from-emerald-800 to-emerald-600 hover:from-emerald-800 hover:to-emerald-600 transition-all duration-300 transform hover:scale-[1.02] shadow-lg mt-6"
              >
                Create Account
              </Button>
            </form>
